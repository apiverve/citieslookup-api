...
const (
	baseURL        = "https://api.apiverve.com/v1/citieslookup"
	defaultTimeout = 30 * time.Second
)

// Client is the Cities Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Cities Lookup API client.
...
// Execute makes a request to the Cities Lookup API with typed parameters.
//
