...
class citieslookupWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/citieslookup');
        }
        ...
        this.validationRules = {"city":{"type":"string","required":true},"limit":{"type":"integer","required":false,"min":1,"max":20,"default":1}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/citieslookup`);
        }
    }
...
module.exports = citieslookupWrapper;
