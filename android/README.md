...
```gradle
dependencies {
    implementation 'com.github.apiverve:citieslookup-api:1.1.14'
}
```
...
```java
import com.apiverve.citieslookup.CitiesLookupAPIClient;
import com.apiverve.citieslookup.APIResponse;
import com.apiverve.citieslookup.APIException;

// Initialize the client
CitiesLookupAPIClient client = new CitiesLookupAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/citieslookup](https://docs.apiverve.com/ref/citieslookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/citieslookup](https://docs.apiverve.com/ref/citieslookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/citieslookup-api/issues)
