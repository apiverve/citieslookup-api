...
namespace APIVerve\Citieslookup;
...
/**
 * Client for the Cities Lookup API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/citieslookup?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/citieslookup';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CitieslookupClient] {$message}\n";
        }
    }
}
